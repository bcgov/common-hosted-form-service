...
describe('form actions', () => {
  ...
  it('readFormSubscriptionData should commit to SET_SUBSCRPTION_DATA', async () => {
    ...
    expect(mockStore.commit).toHaveBeenCalledTimes(1);
    expect(mockStore.commit).toHaveBeenCalledWith('SET_SUBSCRPTION_DATA', expect.any(Object));
  });
});
