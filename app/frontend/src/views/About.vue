  ...
  <div class="about-layout">
    <v-sheet class="help-highlight pa-5 text-center">
      <v-row justify="center">
        <v-col lg="8">
          ...
          <p>
            All B.C. Government employees or contractors with an IDIR account can use our hosted version of Common Hosted Forms Service (CHEFS) to create
            forms.<br />
          </p>
    ...
    <v-row justify="center" class="example-text">
      <v-col cols="12" lg="4">
        ...
        <p>
          With CHEFS, you can create secure forms with an intuitive drag-and-drop interface. You can add form components, re-arrange them, and drop them into
          different layouts configurations.
        </p>
      </v-col>
      <v-col cols="12" lg="4">
        <BaseImagePopout
