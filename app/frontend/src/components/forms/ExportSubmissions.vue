...
export default {
  ...
  computed: {
    ...
    ...mapGetters('form', ['form', 'userFormPreferences', 'formFields', 'submissionList']),
      ...
      try {
        ...
        if (this.submissionList.length > 500 || this.formFields.length > 70) {
          ...
          this.addNotification({
            ...
            message: `Export in progress... An email will be send to ${this.email} containing a link to download your data when it is ready.`,
          });
        }
