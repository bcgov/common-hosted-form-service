...
export default {
  ...
  async mounted() {
    await this.getEncryptionKeyAlgorithms();
    await this.fetchEventStreamConfig();
  },
  methods: {
    ...mapActions(useNotificationStore, ['addNotification']),
    async fetchEventStreamConfig() {
      this.loading = true;
      try {
        const result = await eventStreamConfigService.getEventStreamConfig(
          this.form.id
        );
    ...
    async getEncryptionKeyAlgorithms() {
      try {
