...
export default {
  ...
  async getEachFCProactiveHelpVersion(componentName, version) {
    return appAxios().get(`${ApiRoutes.ADMIN}/formcomponents/proactivehelp/version`, { params: { componentName: componentName, version:version } });
  },
