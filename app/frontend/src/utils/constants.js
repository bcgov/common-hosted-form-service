...
export const FormComponentProactiveHelpValues = Object.freeze({
  'Basic Layout': {
    simplecontent: 'Text/Images',
    simplecols2: 'Columns - 2',
    simplecols3: 'Columns - 3',
    simplecols4: 'Columns - 4',
    simpletabs: 'Tabs',
    simplepanel: 'Panel',
  },
  'Basic Fields': {
    simpletextfield: 'Text Field',
    simpletextarea: 'Multi-line Text',
    simpleselect: 'Select List',
    simplecheckbox: 'Checkbox',
    simplecheckboxes: 'Checkbox Group',
    simpleradios: 'Radio Group',
    simplenumber: 'Number',
    simplephonenumber: 'Phone Number',
    simpleemail: 'Email',
    simpledatetime: 'Date / Time',
    simpleday: 'Day',
  },
  'Advanced Layout': {
  ...
  'Advanced Fields': {
    simpletextfieldadvanced: 'Text Field',
    simpleemailadvanced: 'Email',
    simpletextareaadvanced: 'Text Area',
    simpleurladvanced: 'Url',
    simplenumberadvanced: 'Number',
    simplephonenumberadvanced: 'Phone Number',
    simpletagsadvanced: 'Tags',
    simpleaddressadvanced: 'Address',
    simplepasswordadvanced: 'Password',
    simpledatetimeadvanced: 'Date / Time',
    simplecheckboxadvanced: 'Checkbox',
    simpledayadvanced: 'Day',
    simpletimeadvanced: 'Time',
    simpleselectboxesadvanced: 'Select Boxes',
    simpleselectadvanced: 'Select',
    simplecurrencyadvanced: 'Currency',
    simpleradioadvanced: 'Radio',
    simplesurveyadvanced: 'Survey',
    simplesignatureadvanced: 'Signature',
  },
  'Advanced Data': {
    hidden: 'Hidden',
    container: 'Container',
  ...
  'BC Government': {
    simplefile: 'File Upload',
    orgbook: 'Business Name Search',
    bcaddress: 'BC Address',
    simplebcaddress: 'Simple BC Address',
  },
});
