...
app.use(function (req, res, next) {
  res.setHeader(
    ...
    "default-src 'self'; font-src 'self' https://fonts.gstatic.com; img-src 'self'; script-src 'self'; style-src 'self' https://fonts.googleapis.com; frame-src 'self'; frame-ancestors 'self'; form-action 'self'; connect-src https://dev.loginproxy.gov.bc.ca/"
  );
  next();
});
