...
app.use(function (req, res, next) {
  res.setHeader(
    ...
    "default-src 'self' https:; font-src 'self' https://fonts.gstatic.com; img-src 'self'; script-src 'self' https://cdn.form.io 'unsafe-eval' https:; style-src 'self' https://fonts.googleapis.com 'unsafe-inline'; frame-src 'self'; frame-ancestors 'self'; form-action 'self'; connect-src 'self' https://loginproxy.gov.bc.ca/ https://test.loginproxy.gov.bc.ca/ https://dev.loginproxy.gov.bc.ca/"
  );
  next();
});
