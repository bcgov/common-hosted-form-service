...
app.use(function (req, res, next) {
  res.setHeader(
    ...
    "default-src 'self'; font-src 'self' https://fonts.gstatic.com; img-src 'self' data:; script-src 'self' https://cdn.form.io 'unsafe-eval' blob:https://chefs-dev.apps.silver.devops.gov.bc.ca; style-src 'self' https://fonts.googleapis.com 'unsafe-inline'; frame-src 'self'; frame-ancestors 'self'; form-action 'self'; connect-src 'self' https://loginproxy.gov.bc.ca/ https://test.loginproxy.gov.bc.ca/ https://dev.loginproxy.gov.bc.ca/"
  );
  next();
});
