...
describe('deleteMutipleSubmissions', () => {
  ...
  it('should delete the selected submissions', async () => {
    ...
    const returnValue = {submission: [{id: submissionId1, formVersionId: '8d8e24ce-326f-4536-9100-a0844c27d5a0', confirmationId: 'AC4EF441', draft: false, deleted: true},
      {id: submissionId2, formVersionId: '8d8e24ce-326f-4536-9100-a0844c27d5a0',
    ...
    expect(MockModel.patch).toHaveBeenCalledWith({deleted: true,
...
describe('restoreMutipleSubmissions', () => {
  ...
  it('should delete the selected submissions', async () => {
    ...
    const returnValue = {submission: [{id: submissionId1, formVersionId: '8d8e24ce-326f-4536-9100-a0844c27d5a0', confirmationId: 'AC4EF441', draft: false, deleted: false},
      {id: submissionId2, formVersionId: '8d8e24ce-326f-4536-9100-a0844c27d5a0',
    ...
    expect(MockModel.query).toHaveBeenCalledWith(expect.anything());
    expect(MockModel.patch).toHaveBeenCalledTimes(1);
    expect(MockModel.patch).toHaveBeenCalledWith({deleted: false,
      updatedBy: currentUser.usernameIdp});
    expect(MockModel.whereIn).toHaveBeenCalledTimes(1);
    expect(MockModel.whereIn).toHaveBeenCalledWith('id',submissionIds);
    expect(spy).toHaveBeenCalledWith(submissionIds);
