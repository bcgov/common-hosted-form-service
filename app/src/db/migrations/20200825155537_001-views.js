...
union
select u2.id as "userId", f2.id as "formId", '{}'::varchar[] as permissions
...
select null as "userId", null as "keycloakId", 'public' as username, 'public' as "fullName", null as "firstName", null as "lastName", null as email, f.id as "formId", f.name as "formName", f.labels, f."identityProviders", f.idps, f.active, f."formVersionId", f.version, '{}'::varchar[] as roles, '{}'::varchar[] as permissions
from form_vw f
