...
exports.up = function (knex) {
  return Promise.resolve()
    ...
    select r."userId", u."keycloakId", u.username, u."fullName", u."firstName", u."lastName", u.email, r."formId", f.name as "formName", f.labels, f."identityProviders", f.idps, f.active, f."formVersionId", f.version, r.roles, p.permissions, f.description as "formDescription"
...
exports.down = function (knex) {
  ...
  return Promise.resolve()
    .then(() => knex.schema.raw(`create or replace user_form_access_vw as
