...
var ParentComponent = Components.components.address;
var ID = 'bcaddress';
var DISPLAY = 'BC Address';
var Component = /** @class */ (function (_super) {
    ...
    Component.prototype.attach = function (element) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, providerOptions, queryParameters;
            return __generator(this, function (_b) {
                _super.prototype.attach.call(this, element);
                try {
                    _a = this.component, providerOptions = _a.providerOptions, queryParameters = _a.queryParameters;
                    if (providerOptions) {
                        if (!providerOptions.params) {
                            providerOptions["params"] = {};
                        }
                        if (queryParameters) {
                            providerOptions.params = __assign(__assign({}, providerOptions.params), queryParameters);
                        }
                    }
                }
                catch (err) {
                    console.log("This error is from Custom BC Address component in form.io: Failed to acquire configuration: ".concat(err.message));
                }
                return [2 /*return*/];
            });
        });
