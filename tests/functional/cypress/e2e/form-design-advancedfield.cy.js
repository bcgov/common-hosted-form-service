...
describe("Form Designer", () => {
  ...
  it("Verify submission", () => {
    ...
    cy.location("search").then((search) => {
      ...
      cy.get(":nth-child(2) > .d-print-none > :nth-child(1) > .v-btn").should(
        "be.visible"
      );
      ...
      cy.get(".col-md-9 > a")
        .should("have.attr", "ref")
        .and("include", "fileLink");
      ...
      cy.get(".choices__inner > .choices__list > .choices__item").contains(
        "hello"
      );
