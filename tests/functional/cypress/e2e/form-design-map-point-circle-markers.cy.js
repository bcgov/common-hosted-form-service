...
describe("Form Designer", () => {
  ...
  it("Checks Map component for Line marker", () => {
    ...
    cy.get(
      'div[class="leaflet-container leaflet-touch leaflet-fade-anim leaflet-touch-zoom leaflet-grab leaflet-touch-drag"]'
    ).then(($el) => {
  ...
  it("Checks Map component for Geo search Location", () => {
    ...
    cy.location("search").then((search) => {
      ...
      cy.get(
        '[title="Click to recenter the map to default view"] > .leaflet-control-button > .fa'
      ).click();
      cy.wait(2000);
      cy.get("p")
        .contains("Map recentered to default view")
        .should("be.visible");
