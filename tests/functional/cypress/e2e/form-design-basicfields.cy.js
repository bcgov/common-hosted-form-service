...
// Verifying fields in the form settings page
  it('Basic Fields components', () => {
    ...
    cy.get('div.formio-builder-form').then($el => {
        ...
        .trigger('mousedown', { which: 1}, { force: true })
        .trigger('mousemove', coords1.x, +1, { force: true })
        .trigger('mouseup', { force: true });
        cy.get('input[name="data[label]"]').clear();
        cy.get('input[name="data[label]"]').clear();
    ...
    cy.get('div.formio-builder-form').then($el => {
        ...
        .trigger('mousedown', { which: 1}, { force: true })
        .trigger('mousemove', coords2.x, +1, { force: true })
        .trigger('mouseup', { force: true });
    ...
    cy.get('div.formio-builder-form').then($el => {
        ...
        .trigger('mousedown', { which: 1}, { force: true })
        .trigger('mousemove', coords3.x, +1, { force: true })
        .trigger('mouseup', { force: true });
