...
describe("Form Designer", () => {
  ...
  it("Form Submission and Updation", () => {
    ...
    cy.location("search").then((search) => {
      ...
      cy.get(
        ".v-data-table-footer__items-per-page > .v-input > .v-input__control > .v-field > .v-field__append-inner > .mdi-menu-down"
      ).click();
  ...
  it("Submission status Assignment", () => {
    ...
    cy.get('input[type="checkbox"]').then(($el) => {
      ...
      cy.get(
        ":nth-child(6) > .v-data-table-header__content > .mdi-arrow-up"
      ).should("exist");
      cy.get(
        ":nth-child(6) > .v-data-table-header__content > .mdi-arrow-up"
      ).click();
    ...
    cy.get(
      '[data-test="canCloseStatusPanel"] > .v-btn__content > span'
    ).click();
    cy.get(
      '[data-test="showStatusList"] > .v-input__control > .v-field > .v-field__field > .v-field__input'
    ).click();
    ...
    cy.location("search").then((search) => {
      ...
      cy.get(
        ".v-data-table-column--align-end > .d-flex > :nth-child(2) > a > .v-btn"
      );
